#!/usr/bin/env bash
#
# Register the operations tour manifest for a Wardley Mapping project.
#
# Usage:
#   wm-tour-operations/scripts/register-tour.sh --client CLIENT --project PROJECT \
...
#   clients/{client}/projects/{slug}/presentations/operations/manifest.json
