#!/usr/bin/env bash
#
# Register the executive tour manifest for a Wardley Mapping project.
#
# Usage:
#   wm-tour-executive/scripts/register-tour.sh --client CLIENT --project PROJECT \
...
#   clients/{client}/projects/{slug}/presentations/executive/manifest.json
