#!/usr/bin/env bash
#
# Register the technical tour manifest for a Wardley Mapping project.
#
# Usage:
#   wm-tour-technical/scripts/register-tour.sh --client CLIENT --project PROJECT \
...
#   clients/{client}/projects/{slug}/presentations/technical/manifest.json
