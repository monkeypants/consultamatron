#!/usr/bin/env bash
#
# Register the investor tour manifest for a Wardley Mapping project.
#
# Usage:
#   wm-tour-investor/scripts/register-tour.sh --client CLIENT --project PROJECT \
...
#   clients/{client}/projects/{slug}/presentations/investor/manifest.json
