#!/usr/bin/env bash
#
# Record an iteration update to the complexity audit.
#
# Usage:
#   ca-iterate/scripts/record-update.sh --client CLIENT --engagement ENGAGEMENT \
#     --project PROJECT --title "Description of change" \
#     --field "Changes=..." --field "Reason=..."
#
