#!/usr/bin/env bash
#
# Record that the supply chain has been agreed for a Wardley Mapping project.
#
# Usage:
#   wm-chain/scripts/record-agreement.sh --client CLIENT --engagement ENGAGEMENT \
#     --project PROJECT \
#     --field "Components=..." --field "Shared components=..." --field "Scope notes=..."
#
